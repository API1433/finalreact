                    ...
                    <form onSubmit={handleSubmit} className="add_project_form">
                        <div className="page-bottom">
                            <Row>
                                ...
                                <Col md={14} sm={24} xs={24} className="prodetails">
                                    <div className="shadow-card-body " id="card-block" style={{textAlign:"justify"}}>

                                        <h5 className="m-b-20 p-b-5 b-b-default f-w-600"> Personal Information</h5>
